...
I am highly motivated to learn new technologies, improve my problem-solving skills, and contribute to software development teams through internships or entry-level opportunities.
...
**Backend Development**  
REST API Development, Flask Framework, CRUD Operations, Data Validation, Authentication, JSON Handling  

**Data Science & Machine Learning**  
Data Analysis, Data Cleaning, Data Visualization, Feature Engineering, Model Training, Model Evaluation, Predictive Modeling  

**Tools & Technologies**  
Git, GitHub, VS Code, Command Prompt, PowerShell, Postman, Virtual Environment (venv)  

**Core Concepts**  
Data Structures, Algorithms, Object-Oriented Programming (OOP), Debugging, System Design Basics  
